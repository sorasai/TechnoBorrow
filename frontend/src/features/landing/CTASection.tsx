        ...
        <section id="cta" className="lp-cta">
            <div className="lp-cta__inner">
                ...
                <div className="lp-cta__btns">
                    <button className="lp-hero__btn-primary" onClick={() => navigate("/register")}>Create Account</button>
                    <button className="lp-hero__btn-secondary" onClick={() => navigate("/login")}>Sign In</button>
                </div>
            </div>
        </section>
    );
